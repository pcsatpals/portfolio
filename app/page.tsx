...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen items-center max-w-6xl mx-auto">
      <Hero />
      <WorkExperience />
      <div className='flex flex-col gap-8 w-full sm:mt-40 mt-20 font-preahvihear-sans px-10 xl:px-0'>
        ...
        <Image src="/tech.svg" height={1200} width={1200} alt='work Experience' className='xl:h-[656px] sm:h-[504px] sm:w-auto w-full h-auto' />
      </div>
    </main>
  );
}
