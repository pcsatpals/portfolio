        ...
        <div className='flex flex-col gap-3 w-full font-preahvihear-sans'>
            <div className='flex sm:flex-row flex-col -mt-10 sm:mt-10 xl:mt-21.75 w-full'>
                <motion.div
                    ...
                    className='w-85 xl:w-[30%] h-107.75 mx-auto sm:mx-0 inset-0 bg-transparent rounded-full overflow-visible relative'
                    style={{
                ...
                >
                    <MotionImage
                        ...
                        height={1800}
                        alt="Me"
                        className="size-[198px] z-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
                ...
                <motion.div
                    ...
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ duration: 0.6, ease: "easeOut" }}
                    className='flex flex-col justify-center sm:-ml-10 sm:mt-0 -mt-10 px-10 sm:px-0 '>
            ...
            <motion.div
                ...
                transition={{ duration: 0.9, ease: "easeOut" }} className='px-6 sm:px-10 xl:px-0 sm:mt-0 mt-10'>
                ...
                <div className='sm:text-sm text-xs flex flex-wrap w-full items-center gap-1'>{"Currently, I'm working as a Software Developer "}<span className='flex items-center gap-2'> at <br className='sm:hidden' /> <SL_Logo className="h-8 w-20 shrink-0" /></span></div>
            </motion.div>
            <p className='sm:text-[22px] w-full mt-25 xl:max-w-[80%] px-6 sm:px-10 xl:px-0'>
